 ...
 */
public class RecordingsRecyclerSectionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecordingsRecyclerSectionAdapter(Context context, int sectionResourceId, int textResourceId,
        ...
        this.baseAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onChanged() {
                mValid = RecordingsRecyclerSectionAdapter.this.baseAdapter.getItemCount()>0;
